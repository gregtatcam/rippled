...
private:
    ...
    testInstanceCreate()
    {
        ...
        // IOU to MPT + transfer fee
        {
            ...
            AMM ammAlice(env, alice, USD(20'000), MBTC(20'000));
            BEAST_EXPECT(ammAlice.expectBalances(
                USD(20'000), MBTC(20'000), IOUAmount{20'000, 0}));
            BEAST_EXPECT(expectLine(env, alice, USD(0)));
            // alice initially had 30'000
            BEAST_EXPECT(expectMPT(env, alice, MBTC(10'000)));
        }
        ...
        // Require authorization is set, account is authorized
        {
            ...
            MPTTester MBTC(
                {.env = env,
                 ...
                 .authHolder = true});
            AMM ammAlice(env, alice, USD(10'000), MBTC(10'000));
        }
        ...
        // Cleared global freeze
        {
            ...
            AMM ammAliceFail(
                env, alice, XRP(10'000), MUSD(10'000), ter(tecFROZEN));
            MUSD.set({.flags = tfMPTUnlock});
            AMM ammAlice(env, alice, XRP(10'000), MUSD(10'000));
        }
    }
