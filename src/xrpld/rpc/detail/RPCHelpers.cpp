    ...
    beast::Journal j)
{
    ...
    {
        JLOG(j.info()) << std::format("Bad {} currency or MPT.", name.c_str());
    ...
    if (jv.isMember(jss::currency))
    {
        ...
        {
            JLOG(j.info()) << std::format("Bad {} currency.", name.c_str());
            return assetError;
        }
        ...
        {
            JLOG(j.info()) << std::format("Bad {} issuer.", name.c_str());
            return issuerError;
        }
        asset = issue;
    }
    ...
    {
        JLOG(j.info()) << std::format(
            "Neither {} currency or MPT is present.", name.c_str());
        return assetError;
    }
