...
CONSTRUCT_TYPED_SFIELD(sfCFTAmount,             "CFTAmount",            UINT64,    14);
CONSTRUCT_TYPED_SFIELD(sfCFTLockedAmount,       "CFTLockedAmount",      UINT64,    15);
...
// Currency
CONSTRUCT_TYPED_SFIELD(sfAssetCode,             "AssetCode",            CURRENCY,   1);
...
CONSTRUCT_TYPED_SFIELD(sfTakerPaysCFTID,        "TakerPaysCFTID",       UINT256,   34);
CONSTRUCT_TYPED_SFIELD(sfTakerGetsCFTID,        "TakerGetsCFTID",       UINT256,   35);
...
CONSTRUCT_UNTYPED_SFIELD(sfCFTokens,            "CFTokens",             ARRAY,     13);
